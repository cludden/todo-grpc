...
func request_Todos_CompleteTodo_0(ctx context.Context, marshaler runtime.Marshaler, client TodosClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CompleteTodoInput
...
func RegisterTodosHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TodosClient) error {
	...
	mux.Handle("POST", pattern_Todos_CompleteTodo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Todos_CompleteTodo_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_Todos_CompleteTodo_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_Todos_CompleteTodo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2}, []string{"todos", "id", "completion"}, ""))
...
var (
	forward_Todos_CompleteTodo_0 = runtime.ForwardResponseMessage
